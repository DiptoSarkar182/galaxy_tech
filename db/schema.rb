...
ActiveRecord::Schema[7.1].define(version: 2024_07_30_060318) do
  ...
  create_table "add_to_wish_lists", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "product_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_add_to_wish_lists_on_product_id"
    t.index ["user_id"], name: "index_add_to_wish_lists_on_user_id"
  end
  ...
  add_foreign_key "add_to_wish_lists", "products"
  add_foreign_key "add_to_wish_lists", "users"
